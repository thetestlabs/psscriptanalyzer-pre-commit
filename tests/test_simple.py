...
from psscriptanalyzer_hook import (
...
class TestPowershellHelpers:
    ...
    def test_escape_powershell_path_no_quotes(self) -> None:
        ...
        result = _escape_powershell_path("/path/to/file.ps1")
    ...
    def test_escape_powershell_path_with_single_quotes(self) -> None:
        ...
        result = _escape_powershell_path("/path/to/file's script.ps1")
    ...
    def test_escape_powershell_path_with_multiple_quotes(self) -> None:
        ...
        result = _escape_powershell_path("path'with'many'quotes.ps1")
    ...
    def test_build_powershell_file_array_single_file(self) -> None:
        ...
        result = _build_powershell_file_array(["test.ps1"])
    ...
    def test_build_powershell_file_array_multiple_files(self) -> None:
        ...
        result = _build_powershell_file_array(["test1.ps1", "test2.ps1"])
    ...
    def test_build_powershell_file_array_with_quotes(self) -> None:
        ...
        result = _build_powershell_file_array(["test's file.ps1"])
...
class TestMain:
    ...
    def test_main_psscriptanalyzer_not_installed_install_fails(self) -> None:
        ...
        with (
            ...
            patch("psscriptanalyzer_hook.check_psscriptanalyzer_installed", return_value=False),
            patch("psscriptanalyzer_hook.install_psscriptanalyzer", return_value=False),
        ):
            result = main(["test.ps1"])
            assert result == 1
    ...
    def test_main_success_with_installation(self) -> None:
        ...
        with (
            patch("psscriptanalyzer_hook.find_powershell", return_value="pwsh"),
            patch("psscriptanalyzer_hook.check_psscriptanalyzer_installed", return_value=False),
            patch("psscriptanalyzer_hook.install_psscriptanalyzer", return_value=True),
    ...
    def test_main_analysis_finds_issues(self) -> None:
        ...
        with (
            patch("psscriptanalyzer_hook.find_powershell", return_value="pwsh"),
            patch("psscriptanalyzer_hook.check_psscriptanalyzer_installed", return_value=True),
            patch("psscriptanalyzer_hook.run_script_analyzer", return_value=1),
        ):
            result = main(["test.ps1"])
            assert result == 1
    ...
    def test_main_with_powershell_lts(self) -> None:
        ...
        with (
            patch("psscriptanalyzer_hook.find_powershell", return_value="pwsh-lts"),
            patch("psscriptanalyzer_hook.check_psscriptanalyzer_installed", return_value=True),
            patch("psscriptanalyzer_hook.run_script_analyzer", return_value=0),
        ):
            result = main(["test.ps1"])
    ...
    def test_main_with_windows_powershell(self) -> None:
        ...
        with (
            patch("psscriptanalyzer_hook.find_powershell", return_value="powershell"),
            patch("psscriptanalyzer_hook.check_psscriptanalyzer_installed", return_value=True),
            patch("psscriptanalyzer_hook.run_script_analyzer", return_value=0),
        ):
            result = main(["test.ps1"])
